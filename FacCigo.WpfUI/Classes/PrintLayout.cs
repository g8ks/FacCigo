...
namespace FacCigo
{
    public class PrintLayout
    {
        ...
        public static readonly PrintLayout CUTSHEETS = new PrintLayout("22cm", "10cm", "0.065cm", "0.20cm");
        ...
        public double Width { get => Size.Width; }
        public double Height { get => Size.Height; }
