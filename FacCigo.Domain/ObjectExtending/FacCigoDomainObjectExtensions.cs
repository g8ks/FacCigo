...
namespace FacCigo.ObjectExtending
{
    public static class FacCigoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the FacCigoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
